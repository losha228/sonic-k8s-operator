...
(cd "${TMP_DIR}"/src/github.com/sonic-net/sonic-k8s-operator; \
    ...
    github.com/openkruise/kruise/pkg/client github.com/sonic-net/sonic-k8s-operator/apis "apps:v1alpha1 apps:v1beta1 policy:v1alpha1" -h ./hack/boilerplate.go.txt)
